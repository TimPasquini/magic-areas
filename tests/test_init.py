...
from custom_components.magic_areas.const import CONF_RELOAD_ON_REGISTRY_CHANGE, DOMAIN
from tests.const import DEFAULT_MOCK_AREA
from tests.helpers import get_basic_config_entry_data, init_integration as init_integration_helper, shutdown_integration
