...
class TestGetHighestPriorityState:
    ...
    def test_returns_highest_priority_state(self):
    ...
    def test_works_with_set_input(self):
        ...
        states = {AreaStates.OCCUPIED, AreaStates.EXTENDED}
        assert get_highest_priority_state(states) == AreaStates.EXTENDED
    ...
    def test_uses_default_priority_order(self):
...
class TestFilterByPriority:
    ...
    def test_filters_to_priority_when_present(self):
    ...
    def test_keeps_all_when_no_priority(self):
    ...
    def test_multiple_priority_states(self):
    ...
    def test_preserves_order_when_no_priority(self):
    ...
    def test_accent_state_filtering(self):
...
class TestHasAnyPriorityState:
    ...
    def test_returns_true_when_priority_present(self):
    ...
    def test_returns_false_when_no_priority(self):
...
class TestConstants:
    ...
    def test_default_state_priority_contains_all_states(self):
    ...
    def test_light_priority_states_correct(self):
