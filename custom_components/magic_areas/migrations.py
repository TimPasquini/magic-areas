...
async def _migrate_2_2_to_2_3(
    ...
    if CONF_LIGHT_GROUP_OUTSIDE_CONTEXT_SOURCE not in light_cfg:
        ...
        changed = True
    if CONF_LIGHT_GROUP_INSIDE_BRIGHT_ENTITY not in light_cfg:
        light_cfg[CONF_LIGHT_GROUP_INSIDE_BRIGHT_ENTITY] = ""
        changed = True
    if CONF_LIGHT_GROUP_OUTSIDE_BRIGHT_ENTITY not in light_cfg:
        light_cfg[CONF_LIGHT_GROUP_OUTSIDE_BRIGHT_ENTITY] = ""
        changed = True
