...
class GroupRegistry:
    ...
    def register_default(self, definition: ControlGroupDefinition) -> None:
    ...
    def register_area_default(
        self, area_id: str, definition: ControlGroupDefinition
    ) -> None:
    ...
    def register_custom(self, area_id: str, definition: ControlGroupDefinition) -> None:
