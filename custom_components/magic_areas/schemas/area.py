...
Extracted from const.py. Depends on const keys/defaults and CalculationMode enum.
"""
...
from custom_components.magic_areas.const import (
    CONF_DARK_ENTITY, CONF_ACCENT_ENTITY, CONF_SLEEP_ENTITY,
    CONF_SLEEP_TIMEOUT, CONF_EXTENDED_TIME, CONF_EXTENDED_TIMEOUT, CONF_SECONDARY_STATES_CALCULATION_MODE, CONF_TYPE,
    CONF_INCLUDE_ENTITIES, CONF_EXCLUDE_ENTITIES, CONF_KEEP_ONLY_ENTITIES, CONF_PRESENCE_DEVICE_PLATFORMS,
    CONF_PRESENCE_SENSOR_DEVICE_CLASS, CONF_CLEAR_TIMEOUT, CONF_ENABLED_FEATURES, CONF_SECONDARY_STATES,
    CONF_RELOAD_ON_REGISTRY_CHANGE, CONF_IGNORE_DIAGNOSTIC_ENTITIES, DEFAULT_SLEEP_TIMEOUT, DEFAULT_EXTENDED_TIME,
    DEFAULT_EXTENDED_TIMEOUT, DEFAULT_SECONDARY_STATES_CALCULATION_MODE, DEFAULT_TYPE,
    DEFAULT_PRESENCE_DEVICE_PLATFORMS, DEFAULT_CLEAR_TIMEOUT,
    DEFAULT_CLEAR_TIMEOUT_META, DEFAULT_RELOAD_ON_REGISTRY_CHANGE, DEFAULT_IGNORE_DIAGNOSTIC_ENTITIES,
    AREA_TYPE_INTERIOR, AREA_TYPE_EXTERIOR, AREA_TYPE_META
)
...
SECONDARY_STATES_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_EXTENDED_TIMEOUT, default=DEFAULT_EXTENDED_TIMEOUT): cv.positive_int,
    },
...
REGULAR_AREA_BASIC_OPTIONS_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_RELOAD_ON_REGISTRY_CHANGE, default=DEFAULT_RELOAD_ON_REGISTRY_CHANGE): cv.boolean,
        vol.Optional(CONF_IGNORE_DIAGNOSTIC_ENTITIES, default=DEFAULT_IGNORE_DIAGNOSTIC_ENTITIES): cv.boolean,
    },
    extra=vol.REMOVE_EXTRA,
)
...
REGULAR_AREA_PRESENCE_TRACKING_OPTIONS_SCHEMA = vol.Schema(
    {
        vol.Optional(CONF_PRESENCE_DEVICE_PLATFORMS, default=DEFAULT_PRESENCE_DEVICE_PLATFORMS): cv.ensure_list,
...
META_AREA_PRESENCE_TRACKING_OPTIONS_SCHEMA = vol.Schema(
    {
        vol.Optional(CONF_CLEAR_TIMEOUT, default=DEFAULT_CLEAR_TIMEOUT_META): cv.positive_int,
    },
    extra=vol.REMOVE_EXTRA,
)
...
META_AREA_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_RELOAD_ON_REGISTRY_CHANGE, default=DEFAULT_RELOAD_ON_REGISTRY_CHANGE): cv.boolean,
        vol.Optional(CONF_CLEAR_TIMEOUT, default=DEFAULT_CLEAR_TIMEOUT_META): cv.positive_int,
        vol.Optional(CONF_SECONDARY_STATES, default={}): META_AREA_SECONDARY_STATES_SCHEMA,
    },
    extra=vol.REMOVE_EXTRA,
)

AREA_SCHEMA = vol.Schema(vol.Any(REGULAR_AREA_SCHEMA, META_AREA_SCHEMA), extra=vol.REMOVE_EXTRA)

_DOMAIN_SCHEMA = vol.Schema({cv.slug: vol.Any(AREA_SCHEMA, None)}, extra=vol.REMOVE_EXTRA)
