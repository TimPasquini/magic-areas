...
FEATURE_OPTION_DEFAULTS: dict[MagicAreasFeatures, FeatureOptionDefaults] = {
    ...
    MagicAreasFeatures.COVER_GROUPS: {
        CONF_COVER_GROUPS_AUTOMATION_DEVICE_CLASSES: list(
            DEFAULT_COVER_AUTOMATION_DEVICE_CLASSES
        ),
        CONF_COVER_GROUPS_MANUAL_HOLD_SECONDS: 900,
        CONF_COVER_GROUPS_DAYLIGHT_ACTION: DEFAULT_COVER_PRESETS[
            CoverPresetRole.DAYLIGHT
        ].action.value,
        CONF_COVER_GROUPS_DAYLIGHT_STATES: list(
            DEFAULT_COVER_PRESETS[CoverPresetRole.DAYLIGHT].states
        ),
        CONF_COVER_GROUPS_PRIVACY_ACTION: DEFAULT_COVER_PRESETS[
            CoverPresetRole.PRIVACY
        ].action.value,
        CONF_COVER_GROUPS_PRIVACY_STATES: list(
            DEFAULT_COVER_PRESETS[CoverPresetRole.PRIVACY].states
        ),
        CONF_COVER_GROUPS_ACCENT_ACTION: DEFAULT_COVER_PRESETS[
            CoverPresetRole.ACCENT
        ].action.value,
        CONF_COVER_GROUPS_ACCENT_STATES: list(
            DEFAULT_COVER_PRESETS[CoverPresetRole.ACCENT].states
        ),
    },
    ...
    MagicAreasFeatures.LIGHT_GROUPS: {
        ...
        CONF_LIGHT_GROUP_ADAPTIVE_LIGHTING_MANAGE_ALL: False,
        CONF_LIGHT_GROUP_ADAPTIVE_LIGHTING_SWITCH_SETS: {},
    },
